...
"""
This program examines entries in an UKVS file to remove duplicates. The 
...
first key in the UKVS file and storing it in an array. After that first 
