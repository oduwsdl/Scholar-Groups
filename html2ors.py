...
name of the HTML file to convert to ORS type. The program can convert one or multiple HTML 
...
for a in range(1,arguments):
    ...
    to the ORS file. This facilitates each entry still being a single line in the ORS file that 
    ...
    for i in gs_results:
        ...
        # Items in the ORS file are arrays of entries with each entry being saved as 
